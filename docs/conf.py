...
breathe_projects = { "Imath-test": "doxyxml/" }
breathe_default_project = "Imath-test"
...
latex_documents = [
  ('index', 'Imath-test.tex', 'Imath-test Documentation',
...
man_pages = [
    ('index', 'imath-test', 'Imath-test Documentation',
     ['Thomas Edvalson'], 1)
]
...
texinfo_documents = [
  ('index', 'Imath-test', 'Imath-test Documentation',
   'Thomas Edvalson', 'Imath-test', 'One line description of project.',
   'Miscellaneous'),
]
