...
void register_box(pybind11::class_<T>& c)
{
    ...
    .def("setMin", [](T& self, const V& v) { self.min = v; }, "setMin(point) sets the minimum point of the box")
    .def("setMax", [](T& self, const V& v) { self.max = v; }, "setMax(point) sets the maximum point of the box")
