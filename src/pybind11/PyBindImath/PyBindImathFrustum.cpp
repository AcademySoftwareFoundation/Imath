...
template <class T, class V, class S, class Q>
void register_frustum(pybind11::module& m, const char *name)
{
    ...
    .def(pybind11::init<const Q &, const Q &, const Q &, const Q &>(), pybind11::arg("nearPlane"), pybind11::arg("farPlane"), pybind11::arg("fovx"), pybind11::arg("aspect"), "Initialize with basic frustum properties")
    ...
    .def("set", pybind11::overload_cast<const Q &, const Q &, const Q &, const Q &>(&T::set), pybind11::arg("nearPlane"), pybind11::arg("farPlane"), pybind11::arg("fovx"), pybind11::arg("aspect"), "Set frustum properties")
